...
function flamebubbles_get_theme_defaults() {
	return array(
		...
		'latest_title'                  => __( 'New arrivals built for a premium storefront rhythm.', 'flamebubbles-atelier' ),
		'latest_description'            => __( 'This section stays a clean multi-column grid on tablet and desktop, then converts into a touch-friendly carousel on mobile.', 'flamebubbles-atelier' ),
		...
		'hand_stitch_intro'             => __( 'Designed to feel considered and elevated, this block blends content, trust notes, and curated products for your highest-value handcrafted line.', 'flamebubbles-atelier' ),
		'hand_stitch_panel_title'       => __( 'Why it works', 'flamebubbles-atelier' ),
		'hand_stitch_panel_1'           => __( 'Highlights featured or newest hand stitch products automatically.', 'flamebubbles-atelier' ),
		'hand_stitch_panel_2'           => __( 'Balances editorial spacing with direct purchase intent.', 'flamebubbles-atelier' ),
		'hand_stitch_panel_3'           => __( 'Keeps strong luxury contrast without drifting into generic marketplace styling.', 'flamebubbles-atelier' ),
		...
		'women_story_text'              => __( 'The layout is intentionally clean and spacious so the collection narrative feels premium on desktop, while the product rail remains touch-friendly on smaller screens.', 'flamebubbles-atelier' ),
		'women_story_item_1'            => __( 'Dynamic WooCommerce product pull', 'flamebubbles-atelier' ),
		'women_story_item_2'            => __( 'Variable product pricing supported', 'flamebubbles-atelier' ),
		'women_story_item_3'            => __( 'Responsive editorial layout preserved on tablet', 'flamebubbles-atelier' ),
		...
		'men_story_text'                => __( 'The layout is intentionally clean and spacious so the collection narrative feels premium on desktop, while the product rail remains touch-friendly on smaller screens.', 'flamebubbles-atelier' ),
		'men_story_item_1'              => __( 'Dynamic WooCommerce product pull', 'flamebubbles-atelier' ),
		'men_story_item_2'              => __( 'Variable product pricing supported', 'flamebubbles-atelier' ),
		'men_story_item_3'              => __( 'Responsive editorial layout preserved on tablet', 'flamebubbles-atelier' ),
		'why_eyebrow'                   => __( 'Why Choose Us', 'flamebubbles-atelier' ),
		'why_title'                     => __( 'Luxury feel, commerce discipline, and a fully custom codebase.', 'flamebubbles-atelier' ),
		'why_description'               => __( 'The theme is structured for maintainability, accessibility, and a storefront experience that feels carefully art-directed rather than assembled from defaults.', 'flamebubbles-atelier' ),
		'why_card_1_title'              => __( 'Premium Presentation', 'flamebubbles-atelier' ),
		'why_card_1_text'               => __( 'Editorial composition, strong whitespace, and premium product framing built for fashion.', 'flamebubbles-atelier' ),
		'why_card_2_title'              => __( 'WooCommerce Native', 'flamebubbles-atelier' ),
		'why_card_2_text'               => __( 'Variable products, sale states, related products, cart, and checkout are supported without a page builder.', 'flamebubbles-atelier' ),
		'why_card_3_title'              => __( 'Fast by Design', 'flamebubbles-atelier' ),
		'why_card_3_text'               => __( 'Vanilla JavaScript, modular PHP templates, and performance-aware queries keep the storefront lean.', 'flamebubbles-atelier' ),
		'why_card_4_title'              => __( 'Mobile Ready', 'flamebubbles-atelier' ),
		'why_card_4_text'               => __( 'Card sections turn into horizontal sliders on mobile without sacrificing the premium desktop layout.', 'flamebubbles-atelier' ),
		'testimonials_eyebrow'          => __( 'Testimonials', 'flamebubbles-atelier' ),
		'testimonials_title'            => __( 'Trust signals with a refined editorial tone.', 'flamebubbles-atelier' ),
		'testimonials_description'      => __( 'This section uses clean cards instead of generic sliders so the page keeps a polished fashion-brand rhythm.', 'flamebubbles-atelier' ),
		...
		'gallery_title'                 => __( 'An Instagram-inspired finish with live product imagery.', 'flamebubbles-atelier' ),
		'gallery_description'           => __( 'Instead of static filler, this gallery pulls from WooCommerce products so the storefront keeps feeling current as new collections are added.', 'flamebubbles-atelier' ),
		...
		'footer_widget_fallback'        => __( 'Add shipping notes, support hours, trust badges, or a short newsletter message here from Appearance > Widgets.', 'flamebubbles-atelier' ),
		'footer_bottom_text'            => __( 'Crafted for premium commerce.', 'flamebubbles-atelier' ),
	);
}
